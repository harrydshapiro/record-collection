...
podcastRouter.use("/feed", (req, res) => {
  ...
  res.send(`
    <rss
      ...
      <channel>
        <atom:link rel="self" type="application/atom+xml" href="https://song.haus/podcast/feed" title="MP3 Audio"/>
        <title>song.haus</title>
        <generator>Custom songhaus RSS generator (https://song.haus)</generator>
        ...
        <image>
          <url>https://s3.us-east-1.amazonaws.com/song.haus/full_1703687902-artwork.jpg</url>
          <title>song.haus</title>
          <link>https://song.haus</link>
        </image>
        <itunes:type>episodic</itunes:type>
        <itunes:author>song.haus</itunes:author>
        <itunes:image href="https://s3.us-east-1.amazonaws.com/song.haus/full_1703687902-artwork.jpg"/>
        ...
        <item>
          ...
          <description>
            <![CDATA[ <p>After Spotify wrapped up yall's top songs in 2023, we thought it was time to unwrap the stories behind them.</p><p>We asked song haus members to submit a voice memo about their top songs this year. Huge thanks to all who did. We loved hearing about what 9/11 did to country music, a Fred Again meet-cute, and all the emotional baggage that saddled you last year. Nothing beats some backstory but your music taste. In this episode, we got both.</p> ]]>
          </description>
          <content:encoded>
            <![CDATA[ <p>After Spotify wrapped up yall's top songs in 2023, we thought it was time to unwrap the stories behind them.</p><p>We asked song haus members to submit a voice memo about their top songs this year. Huge thanks to all who did. We loved hearing about what 9/11 did to country music, a Fred Again meet-cute, and all the emotional baggage that saddled you last year. Nothing beats some backstory but your music taste. In this episode, we got both.</p> ]]>
          </content:encoded>
          ...
          <enclosure url="https://s3.us-east-1.amazonaws.com/song.haus/songhaus-pod-1%20-%2012%3A29%3A23%2C%2010.37%E2%80%AFAM.mp3" length="32273182" type="audio/mpeg"/>
          <itunes:author>song.haus</itunes:author>
